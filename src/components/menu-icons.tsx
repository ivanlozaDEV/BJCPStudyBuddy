...
export interface MenuIconProps extends SvgProps {
  name: 'explore' | 'comparator' | 'offflavors' | 'flashcards' | 'settings' | 'glossary' | 'judgeSimulator' | 'myTastings';
}
...
export function MenuIcon({ name, ...props }: MenuIconProps) {
  ...
  switch (name) {
    case "judgeSimulator": // Official Scoresheet Clipboard + Beer Glass + Gold Star
      return (
        <Svg {...defaultProps}>
          {/* Clipboard Board */}
          <Rect x={3} y={4} width={18} height={17} rx={2} fill="#37474F" stroke="#90A4AE" strokeWidth={1.2} />
          {/* Clip on top */}
          <Rect x={8} y={2} width={8} height={3} rx={1} fill="#FFD54F" />
          {/* Score Checklist Lines */}
          <Line x1={6} y1={9} x2={12} y2={9} stroke="#ECEFF1" strokeWidth={1.2} strokeLinecap="round" />
          <Line x1={6} y1={12} x2={11} y2={12} stroke="#ECEFF1" strokeWidth={1.2} strokeLinecap="round" />
          <Line x1={6} y1={15} x2={10} y2={15} stroke="#ECEFF1" strokeWidth={1.2} strokeLinecap="round" />
          {/* Checkmarks */}
          <Polyline points="14 8.5 15 9.5 17 7.5" stroke="#52B788" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
          <Polyline points="14 11.5 15 12.5 17 10.5" stroke="#52B788" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
          {/* Gold Star Badge (50 pts quality) */}
          <G transform="translate(13, 13)">
            <Circle cx={4} cy={4} r={3.5} fill="#F2B824" />
            <Path d="M4 1.5l.8 1.6 1.8.3-1.3 1.3.3 1.8-1.6-.8-1.6.8.3-1.8-1.3-1.3 1.8-.3z" fill="#161B22" />
          </G>
        </Svg>
      );

    case "myTastings": // Tasting Journal Notebook + Beer Bottle
      return (
        <Svg {...defaultProps}>
          {/* Journal Book */}
          <Rect x={4} y={3} width={13} height={18} rx={2} fill="#263238" stroke="#78909C" strokeWidth={1.2} />
          {/* Bookmark ribbon */}
          <Path d="M8 3v6l2-1.5 2 1.5V3H8z" fill="#D90429" />
          {/* Journal page detail lines */}
          <Line x1={7} y1={12} x2={14} y2={12} stroke="#B0BEC5" strokeWidth={1} strokeLinecap="round" />
          <Line x1={7} y1={15} x2={13} y2={15} stroke="#B0BEC5" strokeWidth={1} strokeLinecap="round" />
          {/* Beer Bottle overlay */}
          <G transform="translate(13, 6)">
            {/* Neck */}
            <Path d="M3 1v3l-1.5 2.5v7.5c0 .8.7 1.5 1.5 1.5h2c.8 0 1.5-.7 1.5-1.5V6.5L5 4V1H3z" fill="#60310F" stroke="#FFE082" strokeWidth={0.8} />
            {/* Label */}
            <Rect x={2} y={8.5} width={4} height={4} rx={0.5} fill="#F2B824" />
            {/* Crown cap */}
            <Rect x={2.5} y={0.5} width={3} height={1} rx={0.3} fill="#CFD8DC" />
          </G>
        </Svg>
      );
