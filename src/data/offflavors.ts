...
export const OFF_FLAVORS_DATA: OffFlavor[] = [
  ...
  },
  {
    ...
    prevention_es: "Evita fermentar a temperaturas superiores al rango sugerido para la levadura utilizada. Evita la oxidación de la cerveza. Nunca uses equipos de plástico o vinilo que no estén marcados como grado alimenticio. Algunos plásticos de grado alimenticio liberan toxinas tras alcanzar cierta temperatura. Si las piezas plásticas estarán expuestas a líquidos calientes, verifica el rango de temperatura calificado.",
